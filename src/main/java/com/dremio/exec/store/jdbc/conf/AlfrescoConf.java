...
@SourceType(value = "AlfrescoARP", label = "Alfresco",uiConfig = "alfresco-layout.json")
public class AlfrescoConf extends AbstractArpConf<AlfrescoConf> {
  private static final String ARP_FILENAME = "arp/implementation/alfresco-arp.yaml";
  private static final ArpDialect ARP_DIALECT =
      AbstractArpConf.loadArpFile(ARP_FILENAME, (ArpDialect::new));
  private static final String DRIVER = "cdata.jdbc.alfresco.AlfrescoDriver";
